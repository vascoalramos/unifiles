...
export class AddOwnerComponent implements OnInit {
  ...
  _handleReaderLoaded(e) {
    ...
    this.imageSrc = this.reader.result.split(',')[1];
  }

  addOwner() {
    this.data = this.owner;
    this.data.photo = this.imageSrc;
